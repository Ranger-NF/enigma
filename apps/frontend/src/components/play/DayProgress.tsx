...
const DayProgress: React.FC<DayProgressProps> = ({ day, totalDays = 8, setIsOpen }) => {
  ...
  return (
    <div className="flex items-center justify-between w-full h-[40px] md:h-[70px] border border-white/20 backdrop-blur-md bg-white/10 px-4">
      ...
      <div className="flex gap-2 md:gap-20 justify-center items-center">
        ...
        <div className='relative'>
          <button
            ...
            className="right-0 px-2 lg:px-5 py-0.5 lg:py-3 text-white font-semibold rounded-full border-[1px] border-white shadow-md hover:bg-blue-700 transition"
          >
            ?
          </button>
        </div>
